...
public class UserControllerTest extends AppTest {
    ...
    public void saveUserDetails_mappedTest() {
        String payload = "{" + "\"userName\":\"sample_user\"," + "\"userEmail\":\"user@example.com\"," + "\"userPassword\":\"P@ssw0rd\"," + "\"userPhone\":\"9998885552\"}";
        given()
    ...
    @Test(dependsOnMethods = "saveUserDetails_mappedTest", groups = {"regression","api"})
